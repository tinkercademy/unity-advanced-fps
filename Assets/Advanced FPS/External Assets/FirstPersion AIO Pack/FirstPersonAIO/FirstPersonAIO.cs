...
public class BETA_SETTINGS{
    ...
    private void Update()
    {
        #region Look Settings - Update
            ...
            trueDirection.transform.localRotation = Quaternion.Euler(-followAngles.x + originalRotation.x,0,0);
...
/*     public IEnumerator FOVKickOut()
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Camera Setup
            ...
            // Custom addition for recoil
            t.trueDirection = (Transform)EditorGUILayout.ObjectField(new GUIContent("True Direction", "Direction of camera without recoil"),t.trueDirection,typeof(Transform),true);
